...
To begin contributing to this project, do the following steps:
...
* Open Terminal and navigate to where you want to clone the repo then clone it: `git clone https://github.com/mehrdadrafiee/daric-coin-beta`
